<a href="{{ url()->previous() }}" class="absolute top-96 left-0 w-fit flex gap-x-1.5 items-center transition-all duration-500 m-5 py-2 px-5  rounded-md hover:bg-gray-800 group">
